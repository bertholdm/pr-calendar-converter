function terra_dhatamar(typ, jahr, mona, tag, std, min, sec) {
        ...
        if (mem <= 2.592) {
            ...
            switch (ber) {
                ...
                case 2:
                    tor = 1;
                    ty = Math.floor(mem / t);
                    co1 = Math.floor((mem - ty * t) / c1);
                    co2 = Math.floor((mem - ty * t - c1 * co1) / c2);
                    co3 = (mem - ty * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 3:
                case 4:
                    tor = 2;
                    ty = Math.floor((mem - 36 * t) / t);
                    co1 = Math.floor((mem - (ty + 36) * t) / c1);
                    co2 = Math.floor((mem - (ty + 36) * t - c1 * co1) / c2);
                ...
                case 7:
                    tor = 3;
                    ty = Math.floor((mem - 60 * t) / t);
                    co1 = Math.floor((mem - (ty + 60) * t) / c1);
                    co2 = Math.floor((mem - (ty + 60) * t - c1 * co1) / c2);
                    co3 = (mem - (ty + 60) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 8:
                case 9:
                    tor = 4;
                    ty = Math.floor((mem - 96 * t) / t);
                    co1 = Math.floor((mem - (ty + 96) * t) / c1);
                    co2 = Math.floor((mem - (ty + 96) * t - c1 * co1) / c2);
                ...
                case 12:
                    tor = 5;
                    ty = Math.floor((mem - 120 * t) / t);
                    co1 = Math.floor((mem - (ty + 120) * t) / c1);
                    co2 = Math.floor((mem - (ty + 120) * t - c1 * co1) / c2);
                    co3 = (mem - (ty + 120) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 13:
                case 14:
                    tor = 6;
                    ty = Math.floor((mem - 156 * t) / t);
                    co1 = Math.floor((mem - (ty + 156) * t) / c1);
                    co2 = Math.floor((mem - (ty + 156) * t - c1 * co1) / c2);
                ...
                case 17:
                    tor = 7;
                    ty = Math.floor((mem - 180 * t) / t);
                    co1 = Math.floor((mem - (ty + 180) * t) / c1);
                    co2 = Math.floor((mem - (ty + 180) * t - c1 * co1) / c2);
                    co3 = (mem - (ty + 180) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 18:
                case 19:
                    tor = 8;
                    ty = Math.floor((mem - 216 * t) / t);
                    co1 = Math.floor((mem - (ty + 216) * t) / c1);
                    co2 = Math.floor((mem - (ty + 216) * t - c1 * co1) / c2);
                ...
                case 22:
                    tor = 9;
                    ty = Math.floor((mem - 240 * t) / t);
                    co1 = Math.floor((mem - (ty + 240) * t) / c1);
                    co2 = Math.floor((mem - (ty + 240) * t - c1 * co1) / c2);
                    co3 = (mem - (ty + 240) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 23:
                case 24:
                    tor = 10;
                    ty = Math.floor((mem - 276 * t) / t);
                    co1 = Math.floor((mem - (ty + 276) * t) / c1);
                    co2 = Math.floor((mem - (ty + 276) * t - c1 * co1) / c2);
    ...
    if (time < 0 && time >= -(j3 + 24 * t)) {
        ...
        if (nega <= 2.592) {
            ber = Math.floor(nega / (12 * t));
            switch (ber) {
                case 0:
                case 1:
                case 2:
                    tor = 1;
                    ty = Math.floor(nega / t);
                    co1 = Math.floor((nega - ty * t) / c1);
                    co2 = Math.floor((nega - ty * t - c1 * co1) / c2);
                    co3 = (nega - ty * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 3:
                case 4:
                    tor = 2;
                    ty = Math.floor((nega - 36 * t) / t);
                    co1 = Math.floor((nega - (ty + 36) * t) / c1);
                    co2 = Math.floor((nega - (ty + 36) * t - c1 * co1) / c2);
                ...
                case 7:
                    tor = 3;
                    ty = Math.floor((nega - 60 * t) / t);
                    co1 = Math.floor((nega - (ty + 60) * t) / c1);
                    co2 = Math.floor((nega - (ty + 60) * t - c1 * co1) / c2);
                    co3 = (nega - (ty + 60) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 8:
                case 9:
                    tor = 4;
                    ty = Math.floor((nega - 96 * t) / t);
                    co1 = Math.floor((nega - (ty + 96) * t) / c1);
                    co2 = Math.floor((nega - (ty + 96) * t - c1 * co1) / c2);
                ...
                case 12:
                    tor = 5;
                    ty = Math.floor((nega - 120 * t) / t);
                    co1 = Math.floor((nega - (ty + 120) * t) / c1);
                    co2 = Math.floor((nega - (ty + 120) * t - c1 * co1) / c2);
                    co3 = (nega - (ty + 120) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 13:
                case 14:
                    tor = 6;
                    ty = Math.floor((nega - 156 * t) / t);
                    co1 = Math.floor((nega - (ty + 156) * t) / c1);
                    co2 = Math.floor((nega - (ty + 156) * t - c1 * co1) / c2);
                ...
                case 17:
                    tor = 7;
                    ty = Math.floor((nega - 180 * t) / t);
                    co1 = Math.floor((nega - (ty + 180) * t) / c1);
                    co2 = Math.floor((nega - (ty + 180) * t - c1 * co1) / c2);
                    co3 = (nega - (ty + 180) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 18:
                case 19:
                    tor = 8;
                    ty = Math.floor((nega - 216 * t) / t);
                    co1 = Math.floor((nega - (ty + 216) * t) / c1);
                    co2 = Math.floor((nega - (ty + 216) * t - c1 * co1) / c2);
                ...
                case 22:
                    tor = 9;
                    ty = Math.floor((nega - 240 * t) / t);
                    co1 = Math.floor((nega - (ty + 240) * t) / c1);
                    co2 = Math.floor((nega - (ty + 240) * t - c1 * co1) / c2);
                    co3 = (nega - (ty + 240) * t - c1 * co1 - c2 * co2) / c3;
                    break;
                case 23:
                case 24:
                    tor = 10;
                    ty = Math.floor((nega - 276 * t) / t);
                    co1 = Math.floor((nega - (ty + 276) * t) / c1);
                    co2 = Math.floor((nega - (ty + 276) * t - c1 * co1) / c2);
    ...
    if (time < -(j3 + 24 * t)) {
        ...
        vr0 = Math.floor(time / v0);
        rest = time - vr0 * v0;
        vr1 = Math.floor(rest / v1);
        rest = rest - vr1 * v1;
        vr2 = Math.floor(rest / j3);
    ...
    switch (tor) {
        ...
        case 7:
            ...
            break;
        case 8:
            torname = "der Aizhidos";
            break;
        case 9:
            torname = "des Illhach";
            break;
        case 10:
            torname = "der Thiodege";
            break;
        case 11:
            torname = "des Ezrah";
            break;
        case 12:
            ...
            break;
        case 13:
            torname = "berlen`ty dha vrehetatou";
            break;
    }
    if (tamar > 6500) {
        tamarcomment =
            "Das Lemurische Tammanium gilt ab 6417 dha-Tamar als Untergegangen, Lemuria ab 6500 als zerstoert.";
    }
    return (
        (ty + 1).toString() +
        " ty " +
